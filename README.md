...
Repeat the iteration until the losses become constant and minimum (i) Compute the output using forward pass output (ii) Compute the error
(iii) Compute the change in weight ‘dw’ by using backward propagation algorithm. (iv) Modify the weight as per delta rule. (v) Append the losses in a list
...
<img width="496" alt="neural fig 1" src="https://github.com/Bhavishya203/Experiment-3-Implementation-of-MLP-for-non-linear-separable-problem/assets/94679395/34f3ff8b-ca73-46e5-bf9a-858fc85dfce3">
